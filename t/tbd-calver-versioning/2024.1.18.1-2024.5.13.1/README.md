# Comparing `tmp/tbd_calver_versioning-2024.1.18.1-py3-none-any.whl.zip` & `tmp/tbd_calver_versioning-2024.5.13.1-py3-none-any.whl.zip`

## zipinfo {}

```diff
@@ -1,18 +1,18 @@
-Zip file size: 15808 bytes, number of entries: 16
--rw-r--r--  2.0 unx     3914 b- defN 24-Jan-18 14:47 tbd_calver_versioning.py
--rw-r--r--  2.0 unx      292 b- defN 24-Jan-18 14:47 tbd_calver_versioning-2024.1.18.1.data/data/bin/README.md
--rwxr-xr-x  2.0 unx     5763 b- defN 24-Jan-18 14:47 tbd_calver_versioning-2024.1.18.1.data/data/bin/determine_tbd_calver_version_number.sh
--rwxr-xr-x  2.0 unx      469 b- defN 24-Jan-18 14:47 tbd_calver_versioning-2024.1.18.1.data/data/bin/tag_repo_with_version_number.sh
--rw-r--r--  2.0 unx      326 b- defN 24-Jan-18 14:47 tbd_calver_versioning-2024.1.18.1.data/data/repo_inspection/README.md
--rwxr-xr-x  2.0 unx     1404 b- defN 24-Jan-18 14:47 tbd_calver_versioning-2024.1.18.1.data/data/repo_inspection/checkout_git_repo_properly.sh
--rwxr-xr-x  2.0 unx     1773 b- defN 24-Jan-18 14:47 tbd_calver_versioning-2024.1.18.1.data/data/repo_inspection/configure_credential_helper.sh
--rwxr-xr-x  2.0 unx     1134 b- defN 24-Jan-18 14:47 tbd_calver_versioning-2024.1.18.1.data/data/repo_inspection/determine_commit_where_branch_created.sh
--rwxr-xr-x  2.0 unx     3297 b- defN 24-Jan-18 14:47 tbd_calver_versioning-2024.1.18.1.data/data/repo_inspection/determine_if_changed_files_match_triggers.sh
--rwxr-xr-x  2.0 unx      511 b- defN 24-Jan-18 14:47 tbd_calver_versioning-2024.1.18.1.data/data/repo_inspection/determine_if_commit_is_merge_commit.sh
--rwxr-xr-x  2.0 unx     1379 b- defN 24-Jan-18 14:47 tbd_calver_versioning-2024.1.18.1.data/data/repo_inspection/get_changed_files_on_branch.sh
--rwxr-xr-x  2.0 unx      576 b- defN 24-Jan-18 14:47 tbd_calver_versioning-2024.1.18.1.data/data/repo_inspection/get_changed_files_since_commit.sh
--rw-r--r--  2.0 unx     5497 b- defN 24-Jan-18 16:42 tbd_calver_versioning-2024.1.18.1.dist-info/METADATA
--rw-r--r--  2.0 unx       92 b- defN 24-Jan-18 16:42 tbd_calver_versioning-2024.1.18.1.dist-info/WHEEL
--rw-r--r--  2.0 unx       22 b- defN 24-Jan-18 16:42 tbd_calver_versioning-2024.1.18.1.dist-info/top_level.txt
--rw-rw-r--  2.0 unx     2036 b- defN 24-Jan-18 16:42 tbd_calver_versioning-2024.1.18.1.dist-info/RECORD
-16 files, 28485 bytes uncompressed, 12196 bytes compressed:  57.2%
...
-Filename: tbd_calver_versioning-2024.1.18.1.data/data/bin/README.md
+Filename: tbd_calver_versioning-2024.5.13.1.data/data/bin/README.md
 Comment: 
 
-Filename: tbd_calver_versioning-2024.1.18.1.data/data/bin/determine_tbd_calver_version_number.sh
+Filename: tbd_calver_versioning-2024.5.13.1.data/data/bin/determine_tbd_calver_version_number.sh
 Comment: 
 
-Filename: tbd_calver_versioning-2024.1.18.1.data/data/bin/tag_repo_with_version_number.sh
+Filename: tbd_calver_versioning-2024.5.13.1.data/data/bin/tag_repo_with_version_number.sh
 Comment: 
 
-Filename: tbd_calver_versioning-2024.1.18.1.data/data/repo_inspection/README.md
+Filename: tbd_calver_versioning-2024.5.13.1.data/data/repo_inspection/README.md
 Comment: 
 
-Filename: tbd_calver_versioning-2024.1.18.1.data/data/repo_inspection/checkout_git_repo_properly.sh
+Filename: tbd_calver_versioning-2024.5.13.1.data/data/repo_inspection/checkout_git_repo_properly.sh
 Comment: 
 
-Filename: tbd_calver_versioning-2024.1.18.1.data/data/repo_inspection/configure_credential_helper.sh
+Filename: tbd_calver_versioning-2024.5.13.1.data/data/repo_inspection/configure_credential_helper.sh
 Comment: 
 
-Filename: tbd_calver_versioning-2024.1.18.1.data/data/repo_inspection/determine_commit_where_branch_created.sh
+Filename: tbd_calver_versioning-2024.5.13.1.data/data/repo_inspection/determine_commit_where_branch_created.sh
 Comment: 
 
-Filename: tbd_calver_versioning-2024.1.18.1.data/data/repo_inspection/determine_if_changed_files_match_triggers.sh
+Filename: tbd_calver_versioning-2024.5.13.1.data/data/repo_inspection/determine_if_changed_files_match_triggers.sh
 Comment: 
 
-Filename: tbd_calver_versioning-2024.1.18.1.data/data/repo_inspection/determine_if_commit_is_merge_commit.sh
+Filename: tbd_calver_versioning-2024.5.13.1.data/data/repo_inspection/determine_if_commit_is_merge_commit.sh
 Comment: 
 
-Filename: tbd_calver_versioning-2024.1.18.1.data/data/repo_inspection/get_changed_files_on_branch.sh
+Filename: tbd_calver_versioning-2024.5.13.1.data/data/repo_inspection/get_changed_files_on_branch.sh
 Comment: 
 
-Filename: tbd_calver_versioning-2024.1.18.1.data/data/repo_inspection/get_changed_files_since_commit.sh
+Filename: tbd_calver_versioning-2024.5.13.1.data/data/repo_inspection/get_changed_files_since_commit.sh
 Comment: 
 
-Filename: tbd_calver_versioning-2024.1.18.1.dist-info/METADATA
+Filename: tbd_calver_versioning-2024.5.13.1.dist-info/METADATA
 Comment: 
 
-Filename: tbd_calver_versioning-2024.1.18.1.dist-info/WHEEL
+Filename: tbd_calver_versioning-2024.5.13.1.dist-info/WHEEL
 Comment: 
 
-Filename: tbd_calver_versioning-2024.1.18.1.dist-info/top_level.txt
+Filename: tbd_calver_versioning-2024.5.13.1.dist-info/top_level.txt
 Comment: 
 
-Filename: tbd_calver_versioning-2024.1.18.1.dist-info/RECORD
...
## Comparing `tbd_calver_versioning-2024.1.18.1.data/data/bin/determine_tbd_calver_version_number.sh` & `tbd_calver_versioning-2024.5.13.1.data/data/bin/determine_tbd_calver_version_number.sh`
...
## Comparing `tbd_calver_versioning-2024.1.18.1.data/data/repo_inspection/checkout_git_repo_properly.sh` & `tbd_calver_versioning-2024.5.13.1.data/data/repo_inspection/checkout_git_repo_properly.sh`
...
## Comparing `tbd_calver_versioning-2024.1.18.1.data/data/repo_inspection/configure_credential_helper.sh` & `tbd_calver_versioning-2024.5.13.1.data/data/repo_inspection/configure_credential_helper.sh`
...
## Comparing `tbd_calver_versioning-2024.1.18.1.data/data/repo_inspection/determine_commit_where_branch_created.sh` & `tbd_calver_versioning-2024.5.13.1.data/data/repo_inspection/determine_commit_where_branch_created.sh`
...
## Comparing `tbd_calver_versioning-2024.1.18.1.data/data/repo_inspection/determine_if_changed_files_match_triggers.sh` & `tbd_calver_versioning-2024.5.13.1.data/data/repo_inspection/determine_if_changed_files_match_triggers.sh`
...
## Comparing `tbd_calver_versioning-2024.1.18.1.data/data/repo_inspection/get_changed_files_on_branch.sh` & `tbd_calver_versioning-2024.5.13.1.data/data/repo_inspection/get_changed_files_on_branch.sh`
...
## Comparing `tbd_calver_versioning-2024.1.18.1.dist-info/METADATA` & `tbd_calver_versioning-2024.5.13.1.dist-info/METADATA`
...
-Requires-Dist: ShellUtilities >=2.1.9
-
-# Overview
-
...
## Comparing `tbd_calver_versioning-2024.1.18.1.dist-info/RECORD` & `tbd_calver_versioning-2024.5.13.1.dist-info/RECORD`

 * *Files 16% similar despite different names*

```diff
@@ -1,16 +1,16 @@
-tbd_calver_versioning.py,sha256=a7FtbbbtFhGMpZc43F68x6C0nlovyVnh1vReqkuKcEY,3914
-tbd_calver_versioning-2024.1.18.1.data/data/bin/README.md,sha256=0g5mx6Zqidw_lLlqF9vCL1SPDpCrjpu3-HuNyqTNH4A,292
-tbd_calver_versioning-2024.1.18.1.data/data/bin/determine_tbd_calver_version_number.sh,sha256=2CndliZUww5GZpk0Q9C-LUpCHR45_mTkO3kp8zd4QBs,5763
-tbd_calver_versioning-2024.1.18.1.data/data/bin/tag_repo_with_version_number.sh,sha256=dVTmDWmKyQI1YtXhdYC9aPDfZEI5TbyNFqo1z2w1cLM,469
-tbd_calver_versioning-2024.1.18.1.data/data/repo_inspection/README.md,sha256=de1d6heAP3iAqKzfYjkBZg-JnWxKYdOaahNaFWGdMVM,326
-tbd_calver_versioning-2024.1.18.1.data/data/repo_inspection/checkout_git_repo_properly.sh,sha256=wkF_WlhkYeKHbi29uoYkDUIU6_bP-ZhdY2n1DrMZjqo,1404
-tbd_calver_versioning-2024.1.18.1.data/data/repo_inspection/configure_credential_helper.sh,sha256=CHs1GBqSMl4mvD3N8rCy_fwJ_BdpTR97mW2dJPdtijE,1773
-tbd_calver_versioning-2024.1.18.1.data/data/repo_inspection/determine_commit_where_branch_created.sh,sha256=0YMZ6pG3mf0xqNTBT1jNFWNdSMoLMY7CJAhxiuCeZlM,1134
-tbd_calver_versioning-2024.1.18.1.data/data/repo_inspection/determine_if_changed_files_match_triggers.sh,sha256=Mm97ETydK8sm4w9pvpNOwMeyb6ldV7ksSEB8LAwYQIY,3297
-tbd_calver_versioning-2024.1.18.1.data/data/repo_inspection/determine_if_commit_is_merge_commit.sh,sha256=04zlIGl2rle4W0YPnCcgO7rGnY-ZM2jG1Z176dN4yEU,511
-tbd_calver_versioning-2024.1.18.1.data/data/repo_inspection/get_changed_files_on_branch.sh,sha256=Hc1H0--l9y8jhgPmVA_x4sQ_74d1UyO8BYCYdLbf3Mw,1379
-tbd_calver_versioning-2024.1.18.1.data/data/repo_inspection/get_changed_files_since_commit.sh,sha256=DJvlu9JDH7ztK4WPl6F5Kj809l3MFLSviHdndXkGjgg,576
-tbd_calver_versioning-2024.1.18.1.dist-info/METADATA,sha256=ijLwFQehDHcOo05tExNC8YZcypnrVtiDbNUunS8QTYM,5497
-tbd_calver_versioning-2024.1.18.1.dist-info/WHEEL,sha256=oiQVh_5PnQM0E3gPdiz09WCNmwiHDMaGer_elqB3coM,92
-tbd_calver_versioning-2024.1.18.1.dist-info/top_level.txt,sha256=uD3scoDXjDgk_uJrmSo2HvaDYNBNlc6ao6_W4NS1lQM,22
-tbd_calver_versioning-2024.1.18.1.dist-info/RECORD,,

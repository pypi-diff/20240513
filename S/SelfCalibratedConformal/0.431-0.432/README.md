# Comparing `tmp/SelfCalibratedConformal-0.431.tar.gz` & `tmp/SelfCalibratedConformal-0.432.tar.gz`
...
## Comparing `SelfCalibratedConformal-0.431.tar` & `SelfCalibratedConformal-0.432.tar`
...
### Comparing `SelfCalibratedConformal-0.431/PKG-INFO` & `SelfCalibratedConformal-0.432/PKG-INFO`
...
### Comparing `SelfCalibratedConformal-0.431/SelfCalibratedConformal.egg-info/PKG-INFO` & `SelfCalibratedConformal-0.432/SelfCalibratedConformal.egg-info/PKG-INFO`
...
### Comparing `SelfCalibratedConformal-0.431/setup.py` & `SelfCalibratedConformal-0.432/setup.py`
